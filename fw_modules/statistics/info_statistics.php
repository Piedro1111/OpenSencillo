...
$modname='statistics';
//-------group information-----------------//
$inc->lib['group_'.$modname]['name']='statistics';
$inc->lib['group_'.$modname]['version']=1.0;
$inc->lib['group_'.$modname]['template']=1.0;
...
$inc->lib['group_'.$modname]['homepage']='www.opensencillo.com';
?>
